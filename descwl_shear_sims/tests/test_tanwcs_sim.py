...
from ..tanwcs_sim import TanWCSSim


def test_tanwcs_sim_smoke():
    sim = TanWCSSim(rng=10)
    data = sim.gen_sim()
...
def test_tanwcs_sim_double_call_raises():
    sim = TanWCSSim(rng=10)
    sim.gen_sim()
