...
I highly recommend you follow this tutorial on your laptop or another machine
other than at nersc.  It is possible to do the tutorial at nersc but it will
likely take you longer to get it working.
...
We will get a tar file with data used by the WeakLensingDeblending package to
...
I recommend putting that environment variable into your shell startup file so
you don't have to type that every time.  E.g. in your ~/.bashrc or ~/.csrhc
etc.
...
use the same galaxy catalog as above and turn off stars.
```python
import numpy as np
from descwl_shear_sims.sim import (
...
* Alternative psf models.  Any user can make their own, as shown
    above, but we may decide some PSFs are generally useful and should
